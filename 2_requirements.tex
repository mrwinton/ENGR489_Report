...
\paragraph{F1: The prototype must enable the innovation community to collaborate.}
...
\paragraph{F2: The prototype must store sensitive data securely.}
...
\paragraph{F3:  The prototype must enable users to scope the disclosure of their content/identity.}
...
\paragraph{F4:  The prototype must be portable and extensible.}
...
\paragraph{NF1: The prototype must be performant.}
...
\paragraph{NF2: The prototype must support a distributed architecture.}
