...
The principal function of PitchHub is to facilitate collaboration in the innovation community, this is reflected in requirement D1. As such the design of PitchHub began with specifying these fundamentals in user stories. 

The requirements D2.1 and D2.2 are similarly behaviour-orientated and hence specified in user stories.
