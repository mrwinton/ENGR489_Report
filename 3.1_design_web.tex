...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{wire_frame}
...
\begin{figure}[ht]
    ...
    \caption{Implementation of the ``Show Pitch Card'' page. The primary features are as follows: the Pitch Points to direct collaboration (requirement D1), the ability to suggest/comment (requirement D1), the ability to scope (D2.1), and the ability to audit viewers (requirement D2.2).}
